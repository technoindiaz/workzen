...
class SchoolJobScreen extends StatefulWidget {
  ...
  @override
  _SchoolJobScreenState createState() => _SchoolJobScreenState();
}

class _SchoolJobScreenState extends State<SchoolJobScreen> {
  Future<List<dynamic>> fetchData() async {
    final response = await http.get(Uri.parse(
        'https://technoindiaz.pythonanywhere.com/api/job-posts-by-category/2/'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('School Job List'),
