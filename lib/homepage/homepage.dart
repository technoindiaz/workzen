...
import 'package:workzen/job/license_holder_page.dart';
import 'package:workzen/job/telephonic_interview_page.dart';
            ...
            children: [
              ...
              InkWell(
                onTap: (){
                  Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const LicenseHolder()),
                        );
                },
                child: Card(
                  elevation: 4,
